...
SWEP.Gun = ("m9k_ak47_broken") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Broken AK-47"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM			= 5000			-- This is in Rounds Per Minute
...
SWEP.Primary.Damage		= 10000	-- Base damage per bullet
