...
SWEP.Gun = ("m9k_m4a1_broken") -- must be the name of your swep but NO CAPITALS!
if (GetConVar(SWEP.Gun.."_allowed")) != nil then 
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "bobs_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Category				= "Broken M9K Assault Rifles"
...
SWEP.PrintName				= "Broken M4A1"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM			= 40000			-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 90000		-- Size of a clip
SWEP.Primary.DefaultClip		= 6000		-- Bullets you start with
...
SWEP.Primary.NumShots	= 4000		-- How many bullets to shoot per trigger pull
SWEP.Primary.Damage		= 9999999	-- Base damage per bullet
