...
SWEP.Gun = ("m9k_winchester73_broken") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Broken Winchester"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM				= 4000		-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 2000			-- Size of a clip
SWEP.Primary.DefaultClip			= 4000	-- Default number of bullets in a clip
