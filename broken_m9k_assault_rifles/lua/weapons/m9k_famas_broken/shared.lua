...
SWEP.Gun = ("m9k_famas_broken") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Broken FAMAS"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.ClipSize			= 1284		-- Size of a clip
